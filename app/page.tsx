...
export default function BiyoraHome() {
  ...
  const handlePaystackPayment = () => {
    ...
    if (!process.env.NEXT_PUBLIC_PAYSTACK_PUBLIC_KEY) {
      setToast({ message: "Payment key is missing. Check .env.local", type: "error" });
      return;
    }
    ...
    try {
      ...
      paystack.newTransaction({
        ...
        onError: () => setToast({ message: "Payment error occurred", type: "error" })
      });
    } catch (error) {
      setToast({ message: "Failed to initialize Paystack", type: "error" });
    } finally {
