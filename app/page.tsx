...
export default function Home() {
  ...
  const [customerEmail, setCustomerEmail] = useState("idris81ahmad@gmail.com"); // Pre-filled
  ...
  const handlePaystackPayment = () => {
    ...
    popup.newTransaction({
      key: "pk_test_5b0b08d5e5e22755e8a569b050ead0f4e9588ca4", // Your key
      email: customerEmail,
